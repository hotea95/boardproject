...
<h1>회원 등록</h1>
<form method="post" id="sign_member" onsubmit="return checks()">
<fieldset>
...
<input type="text" name="pwd2" id="pwd2"></p>
<p><label for="이름">이름</label>
<input type="text" name="name" id="name"></p>
<p><label for="email">이메일</label>
<input type="text" name="email" id="email"></p>
<p><label for="phone">전화번호</label>
<input type="text" name="phone" id="phone"></p>
<p><label for="birth">생일</label>
<input type="text" name="birth" id="birth"></p>
<button type="submit" class="btn btn-info" id = "button">등록</button>
<button type="reset" class="btn btn-info" onclick="location.href='./home'">취소</button>
</fieldset>
</form>
</body>
</html>